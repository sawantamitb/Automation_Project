...
public class MyLogger
{
	        		...
	        		try 
	         	    {
	        			...
	        			fileAppender.setWriter(readfilewriter);
	...
	public void writeToInfoLogWithElement(Logger logger, String fatalMsg, Object e)
	{
		logger.fatal((new Date()) +" :: "+" INFORMATION : " +fatalMsg+" : "+e);
	}
